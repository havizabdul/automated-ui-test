...
WebUI.click(findTestObject('Object Repository/Page_New Delivery System/pilih_kewarganegaraan'))


WebUI.click(findTestObject('Object Repository/Page_New Delivery System/pilih_kewarganegaraan',[('Negara') : Kewarganegaraan ]))
